        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ url('buku/edit') }}">
                        {{ csrf_field() }}                        
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="kode_buku" type="number" class="form-control" name="kode_buku" value="{{ $buku->kode_buku }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="judul_buku" type="text" class="form-control" name="judul_buku" value="{{ $buku->judul_buku }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="pengarang" type="text" class="form-control" name="pengarang" value="{{ $buku->pengarang }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="kategori" type="text" class="form-control" name="kategori" value="{{ $buku->kategori }}" required>
